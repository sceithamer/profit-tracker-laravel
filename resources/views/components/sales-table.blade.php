            ...
            <table role="table" aria-label="{{ $title }} - Sortable data table">
                                ...
                                <div style="display: flex; gap: 8px; align-items: center;">
                                    <x-button href="{{ route('sales.edit', $sale) }}" variant="primary" size="small" icon-only aria-label="Edit sale">
                                        <svg class="icon" fill="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M5.25 5.25a3 3 0 0 0-3 3v10.5a3 3 0 0 0 3 3h13.5a3 3 0 0 0 3-3V13.5a.75.75 0 0 0-1.5 0v5.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5V8.25a1.5 1.5 0 0 1 1.5-1.5h5.25a.75.75 0 0 0 0-1.5H5.25Z"/>
                                        </svg>
                                    </x-button>
                                    <form method="POST" action="{{ route('sales.destroy', $sale) }}" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this sale? This action cannot be undone.')">
                                        @csrf
                                        @method('DELETE')
                                        <x-button type="submit" variant="danger" size="small" icon-only aria-label="Delete sale">
                                            <svg class="icon" fill="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <tfoot>
                    <tr class="table-totals" role="row">
                        ...
                        <td colspan="{{ $showStorageUnit && $showPlatform ? '4' : ($showStorageUnit || $showPlatform ? '4' : '4') }}">
